...
class Encoder(nn.Module):
    def __init__(self, embedding,
        ...
        if use_lal:
            ...
            attn = LabelAttention(hparams, d_model, d_k=128, d_v=128, d_l=d_l, d_proj=lal_d_proj, use_resdrop=lal_resdrop,
            ...
            ff_dim = lal_d_proj[0] * d_l
            print(lal_d_proj)
            print(d_l)
            print(lal_d_proj * d_l)
